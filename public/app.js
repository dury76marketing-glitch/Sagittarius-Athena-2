...
const ATTACKS=[
  ...
  {legacy:'Crash Recovery Hunter',name:'Starlight Extinction',key:'crashRecoveryHunterEnabled',stake:'crashRecoveryStakeCents',min:'crashRecoveryMinEntryCents',max:'crashRecoveryMaxEntryCents',pri:'crashRecoveryPri1R2Enabled',fields:[['crashRecoveryPri1R2TriggerCents','PRI1-R2 arm target','c'],['crashRecoveryInfinityNetPerOriginalContractCents','Infinity target when PRI OFF','c'],['crashRecoveryMinCrashCents','Min crash','c'],['crashRecoveryMinReboundCents','Min rebound','c'],['crashRecoveryMinUpwardTicks','Upward ticks','']],desc:'Not a Mega Wave saint. After a real hunter in the same cosmos dies on stop-loss, Starlight may re-enter that exact ticker if its own crash/rebound/uptick and Infinity target allow.'},
