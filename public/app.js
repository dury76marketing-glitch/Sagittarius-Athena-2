...
const ATTACKS=[
  ...
  {legacy:'Recovery Hunter',name:'Crystal Wall',key:'recoveryHunterEnabled',stake:'recoveryStakeCents',min:'recoveryMinEntryCents',max:'recoveryMaxEntryCents',pri:'',fields:[['crystalWallMinCrashCents','Min crash','c'],['crystalWallMinReboundCents','Min rebound','c'],['crystalWallMinUpwardTicks','Upward ticks','']],desc:'Bolt Direct real attack. Atomic Thunder times the entry. Own band and crash/rebound/ticks apply. 0/0/0 = enter on the bolt. Not paper.'},
