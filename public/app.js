...
const SHARED=[
 ['maxPositions','Max Attack Positions',''],['maxRepeatsPerMarket','Max fills per attack per market',''],['repeatCooldownMinutes','Wait after that attack closes','min'],['maxSpreadCents','Shared Max Spread','c'],['startingCapitalCents','Simulation Starting Capital','c'],['simFeeCents','Simulation Fee / Contract','c'],['recoveryTrackingHours','Recovery Research Tracking','h'],
];
