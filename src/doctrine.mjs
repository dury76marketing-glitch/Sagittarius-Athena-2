...
export const SHADOW_ATTACK_CONCEPTS = new Set(['Another Dimension', 'Crystal Wall Shadow']);
...
// R13/MFE1: historical-loss market families remain fully visible to the
// scanner and Crystal Wall shadow research, but they have zero SIM/LIVE
// executable-entry authority for Athena and every real downstream Saint.
export const MARKET_FAMILY_EXECUTION_EXCLUSION = Object.freeze({
  version:'MFE1',
  policyRevision:'MFE1-R2-ITF-MENS-SETTLEMENT-LOSS-HARD-BAN',
  reasonCode:'market_family_historical_loss_exclusion',
  role:'hard_fail_closed_execution_exclusion_for_athena_and_all_real_downstream_saints_while_shadow_research_remains_active',
  modes:Object.freeze(['SIMULATION','LIVE']),
  shadowResearchAllowed:true,
...
export function executionMarketFamilyExclusion(ticker, settings) {
  ...
  return Object.freeze({
    ...
    normalizedTicker,
    reason:matchedRules.length?MARKET_FAMILY_EXECUTION_EXCLUSION.reasonCode:null,
...
export const MEGA_WAVE = Object.freeze({
  version:'MEGA-WAVE-MW1-MW2-MW3',
  policyRevision:'MW3-R1-TRIPLE-CRYSTAL-ATHENA-12-SAINT-RELEASE',
  tripleCrystalRequired:3, // compatibility alias for the historical default
  minimumCrystalProofsRequired:1,
  ...
  allocationDoctrine:'FIRST_QUALIFIED_ATOMIC_STABLE_SAINT_ID_TIEBREAK',
...
export const EXECUTION_ATTACK_DISPLAY = Object.freeze({
  ...
  'Crystal Wall Shadow': Object.freeze({ name:'Crystal Wall', legacy:'Recovery Hunter / shadow' }),
  'Momentum Hunter': Object.freeze({ name:'Great Horn', legacy:'Momentum Hunter' }),
  'Lightning Plasma': Object.freeze({ name:'Lightning Plasma', legacy:'Lightning Plasma / LP1' }),
});
...
export const ATHENA_EXCLAMATION = Object.freeze({
  version:'ATHENA-EXCLAMATION-MW2',
  policyRevision:'MW2-R1-TRIPLE-CRYSTAL-DIRECT-CONTINUATION',
  role:'supreme_first_real_attack_after_configured_crystal_wall_proof_count',
  trigger:'POST_CONFIGURED_CONSECUTIVE_CRYSTAL_WALL_SHADOW_INFINITY_WINS',
  requiredParentConcept:'Crystal Wall Shadow',
  requiredParentVersion:'CRYSTAL-WALL-V3',
  requiredParentPolicyRevision:'CW3-R4-THIRD-PROOF-PROVENANCE',
  thirdProofVersion:'MEGA-WAVE-TRIPLE-CRYSTAL-PROOF-V1',
  requiredConsecutiveProfitableShadowProofs:3, // compatibility/default; runtime operator setting may select 1..5
  minimumConsecutiveProfitableShadowProofs:1,
  maximumConsecutiveProfitableShadowProofs:5,
  proofPairing:'NON_OVERLAPPING_CONSECUTIVE_CONFIGURED_PROOF_GROUPS',
  shadowLossResetsProof:true,
  sameExactTicker:true,
  sameSide:true,
  normalStrategicDiscoveryBypass:true,
  ordinaryCooldownExempt:true,
  ordinaryGameClockExempt:true,
  athenaApprovalRequired:false,
  fullExecutionSafetyRequired:true,
  fullConfiguredSizeRequired:true,
  sourceDoesNotAuthorizeEntry:true,
  strategicEntryAuthority:'MEGA_WAVE_TRIPLE_CRYSTAL_AUTHORITY',
  defaultStakeCents:20_000,
  defaultMinEntryCents:10,
  defaultMaxEntryCents:89,
  defaultMaxSpreadCents:3,
});


export const SCARLET_NEEDLE = Object.freeze({
  version:'SCARLET-NEEDLE-V3',
  policyRevision:'SN3-R5-THIRD-CONSECUTIVE-CW-PROOF',
  role:'post_third_crystal_wall_shadow_win_same_ticker_continuation_attack',
  trigger:'POST_THIRD_CONSECUTIVE_CRYSTAL_WALL_SHADOW_INFINITY_WIN',
  requiredParentConcept:'Crystal Wall Shadow',
  requiredParentVersion:'CRYSTAL-WALL-V3',
  requiredParentPolicyRevision:'CW3-R4-THIRD-PROOF-PROVENANCE',
  thirdProofVersion:'SCARLET-THIRD-PROOF-V1',
  requiredConsecutiveProfitableShadowProofs:3,
  proofPairing:'NON_OVERLAPPING_CONSECUTIVE_PROFIT_TRIPLES',
  shadowLossResetsProof:true,
  ...
  ordinaryGameClockExempt:true,
  athenaApprovalRequired:false,
  athenaSoulHandoffVeto:false,
  fullExecutionSafetyRequired:true,
  fullConfiguredSizeRequired:true,
  defaultMaxRepeats:1,
  maximumConfigurableRepeats:1,
  defaultInfinityNetPerOriginalContractCents:1,
  sourceDoesNotAuthorizeEntry:true,
  strategicEntryAuthority:'SCARLET_NEEDLE_POST_THIRD_CRYSTAL_WALL_SHADOW_WIN_CONTINUATION',
  profitAuthority:'INFINITY_BREAK',
  lossAuthority:'AURORA_EXECUTION',
  noPostEntryTimeExit:true,
});

// Compatibility surface only. SN3 removed the Athena Soul/bounce handoff veto;
// a completed profitable Crystal Wall Infinity close is only the first proof.
// Scarlet authority requires three independent, consecutive profitable Crystal
// Wall shadow episodes on the same exact ticker. The third full Crystal trade is
// the final observation point; any intervening Crystal Wall loss resets the proof
// sequence before real Scarlet capital can be authorized. Hard market, ownership, liquidity and
// execution safety remain in the normal real-Scarlet Hunter pipeline.
export function scarletHandoffGate(){return{ok:true,reason:'sn3_legacy_handoff_gate_disabled'};}




// R63 Gemini / Another Dimension remain an isolated shadow universe. Another
// Dimension applies Great Horn momentum physics to active ordinary Cosmos
// shadows and has zero broker or portfolio-capital authority. SJA3 remains
// isolated from Gemini: Justice Arrow is armed only by a profitable Scarlet
// Needle Infinity close and then observes its own same-ticker pullback/rebound
// parameters directly. CI1 is not an entry prerequisite. ATHENA-X1 remains the
// post-fill profit authority.
...
export const SAGITTARIUS_JUSTICE_ARROW = Object.freeze({
  version:'SAGITTARIUS-JUSTICE-ARROW-V3',
  policyRevision:'MW3-R1-POST-ATHENA-OWN-CONFIRMATION',
  role:'post_profitable_athena_same_ticker_own_pullback_rebound_execution_attack',
  trigger:'POST_PROFITABLE_ATHENA_EXCLAMATION_CLOSE_DIRECT_OWN_CONFIRMATION',
  triggerSources:Object.freeze(['ATHENA_EXCLAMATION_PROFIT_CLOSE']),
  requiredParentConcept:'Athena Exclamation',
  requiredParentVersion:ATHENA_EXCLAMATION.version,
  requiredParentPolicyRevision:ATHENA_EXCLAMATION.policyRevision,
  requiredParentProfitAuthority:'ENTRY_FROZEN_PROFIT_AUTHORITY',
  triggerRequiresPositiveParentRealizedNet:true,
  triggerRequiresAnotherDimensionWin:false,
  independentCrashAuthority:false,
  requiresCi1CrashEpisode:false,
  directObservationFromParentClose:true,
  postScarletContinuationAuthority:true,
  sameExactTicker:true,
  sameSide:true,
  normalStrategicDiscoveryBypass:true,
  athenaEntryAuthority:false,
  atomicThunderAuthority:false,
  ordinaryGameClockExempt:true,
  ordinaryCooldownExempt:true,
  ordinaryEventEntryCapExempt:true,
  fullExecutionSafetyRequired:true,
  fullConfiguredSizeRequired:true,
  fixedStakeOnly:true,
  stakeMultiplierAllowed:false,
  oneEntryPerCrashEpisode:false,
  oneEntryPerParentAthena:true,
  defaultMaxRepeats:1,
  maximumConfigurableRepeats:1,
  reboundRequired:true,
  observationOrigin:'parent_athena_close_then_trailing_peak',
  reboundOrigin:'justice_observation_trough',
  reboundPrice:'best_bid',
  defaultMinCrashCents:15,
  defaultMinReboundCents:5,
  defaultMinUpwardTicks:2,
  defaultStakeCents:500,
  defaultMinEntryCents:10,
  defaultMaxEntryCents:50,
  crashAloneAuthorizesEntry:false,
  strategicEntryAuthority:'MEGA_WAVE_JUSTICE_POST_ATHENA_OWN_CONFIRMATION',
  profitAuthority:'ENTRY_FROZEN_INFINITY_OR_PRI1_R2',
  lossAuthority:'AURORA_EXECUTION',
  noPostEntryTimeExit:true,
});
...
export const BOLT_DIRECT = Object.freeze({
  ...
  excludedAttacks:Object.freeze(['Crash Recovery Hunter','Another Dimension','Recovery Hunter']),
...
// Crystal Wall is intentionally excluded because CW3 has its own CI1 crash
// authority and never consumes ordinary Cosmo GREEN/Athena selection.
export const COSMO_ROUTING = Object.freeze({
  ...
  followOnOnlyExceptions:Object.freeze(['Lightning Plasma']),
  independentAuthorityExceptions:Object.freeze(['Recovery Hunter']),
...
// CW3 Crystal Wall. Independent crash-rebound authority. A CI1 crash episode
// can arm Crystal Wall whether or not Sagittarius already owns the market.
// The crash itself never buys: a new low resets recovery proof, then a bounded
// rebound confirmation may authorize one fixed-stake entry for that exact crash
// episode. Athena/Atomic Thunder and the ordinary game-time/cooldown/event-cap
// strategy gates have no authority over this specialist path. Crystal Wall has
// no broker or portfolio authority; hard market, spread, full-depth, fee,
// virtual Infinity and virtual Aurora truth still apply before it can certify Scarlet.
export const CRYSTAL_WALL = Object.freeze({
  version:'CRYSTAL-WALL-V3',
  policyRevision:'CW3-R4-THIRD-PROOF-PROVENANCE',
  role:'post_infinity_win_same_ticker_follow_up_attack',
  conceptName:'Recovery Hunter',
  shadowConceptName:'Crystal Wall Shadow',
  displayName:'Crystal Wall',
  followVersion:'CW4-FOLLOW',
  followAuthority:'CRYSTAL-WALL-INFINITY-FOLLOW',
  trigger:'PARENT_EXECUTABLE_INFINITY_WIN',
  triggerSources:Object.freeze(['OWNED_REAL_POSITION','TRACKED_MARKET']),
  triggerRequiresHardStop:false,
  sameExactTicker:true,
  sameSide:true,
  normalStrategicDiscoveryBypass:true,
  athenaAuthority:false,
  atomicThunderAuthority:false,
  ordinaryGameClockExempt:true,
  ordinaryCooldownExempt:true,
  ordinaryEventEntryCapExempt:true,
  ...
  maximumConfigurableRepeats:1,
  reboundRequired:true,
  reboundOrigin:'crash_episode_trough',
  reboundPrice:'best_bid',
  defaultMinCrashCents:15,
  defaultMinReboundCents:5,
  defaultMinUpwardTicks:2,
  ...
  defaultMaxEntryCents:50,
  crashAloneAuthorizesEntry:false,
  strategicEntryAuthority:'CRYSTAL-WALL-INFINITY-FOLLOW',
  defaultPriEnabled:true,
  defaultPriArmCents:1,
  defaultPriTrailCents:1,
  virtualProfitAuthority:'INFINITY_BREAK',
  virtualLossAuthority:'AURORA_EXECUTION',
  profitableCloseReason:'crystal_wall_shadow_profit',
  lossCloseReason:'crystal_wall_shadow_aurora',
  maximumRecentResults:100,
  maximumConsumedCrashEpisodes:5000,
  noPostEntryTimeExit:true,
});
...
export const LIGHTNING_PLASMA = Object.freeze({
  ...
  minStrikes:2,
  maxStrikes:3,
  fieldCooldownMs:15_000,
  fieldStakeCents:20_000,
  minEntryCents:20,
  maxEntryCents:89,
  maxSpreadCents:3,
  maxSourceFadeCents:1,
  maxChaseCents:4,
...
export const ATHENA_SOUL = Object.freeze({
  version:'ATHENA-SOUL-S3',
  policyRevision:'S3-R2-SOUL-NEVER-BLOCKS-FIRE',
  role:'per_bolt_story_script_display_shield',
  shieldIsDisplayOnly:true,
  shieldNeverBlocksBolt:true,
  shieldNeverBlocksAthenaFire:true,
  cosmos:Object.freeze(['Pegasus','Dragon','Phoenix']),
  geminiCommandAuthority:false,
  anotherDimensionCommandAuthority:false,
  graveMaxCents:20,
  crownMinCents:80,
  crownMaxCents:89,
  spineMinCents:56,
  ...
  reserveMinCents:56,
  reserveMaxCents:69,
  openers:Object.freeze(['Momentum Hunter','Wave Surfer','Crash Recovery Hunter']),
  winSaints:Object.freeze(['Scarlet Needle','Justice Arrow']),
  woundSaints:Object.freeze(['Lightning Plasma','Crystal Wall']),
  reserveOpeners:Object.freeze(['Crash Recovery Hunter']),
});
...
export const INFINITY_BREAK = Object.freeze({
  ...
  policyRevision:'IB1-R2-AGGREGATE-EXECUTION-TRUTH',
