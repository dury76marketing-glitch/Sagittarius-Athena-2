...
export function originalSettings() {
  return {
    ...
    momentumMinEntryCents: 60,
    momentumMaxEntryCents: 65,
    waveStakeCents: 100,
    waveMinEntryCents: 45,
    waveMaxEntryCents: 50,
    waveMinCrashCents: 0,
    waveMinReboundCents: 0,
    waveMinUpwardTicks: 0,
    recoveryStakeCents: 100,
    recoveryMinEntryCents: 55,
    ...
    justiceArrowMinEntryCents: 40,
    justiceArrowMaxEntryCents: 45,
    ...
    athenaExclamationMaxEntryCents: 35,
    ...
    lightningPlasmaMinEntryCents: 65,
    lightningPlasmaMaxEntryCents: 70,
